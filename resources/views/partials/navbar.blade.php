        ...
        <nav class="flex gap-8 font-semibold text-base items-center">
            ...
            <div class="relative group">
                ...
                <div class="absolute hidden group-hover:block bg-white text-green-900 mt-2 rounded shadow-lg min-w-[220px] z-50">
                    <a href="#" class="block px-4 py-2 hover:bg-green-100">Peraturan Desa</a>
                    <a href="#" class="block px-4 py-2 hover:bg-green-100">Peraturan Kepala Desa</a>
                    <a href="#" class="block px-4 py-2 hover:bg-green-100">Keputusan Kepala Desa</a>
                    <a href="#" class="block px-4 py-2 hover:bg-green-100">Surat Edaran Kepala Desa</a>
                </div>
            </div>
            ...
            <div class="relative group">
                ...
                <div class="absolute hidden group-hover:block bg-white text-green-900 mt-2 rounded shadow-lg min-w-[200px] z-50">
                    <a href="#" class="block px-4 py-2 hover:bg-green-100">Potensi SDM</a>
                    <a href="#" class="block px-4 py-2 hover:bg-green-100">Potensi Wisata</a>
                    <a href="#" class="block px-4 py-2 hover:bg-green-100">Potensi Produk UMKM</a>
                </div>
            </div>
