...
@section('title', 'Detail Wisata - Desa Kampunganyar')
...
$wisata_id = request()->get('id', 'jopuro');
...
<div class="bg-white py-4 px-8">
    <div class="max-w-screen-xl mx-auto">
        <nav class="text-sm text-gray-600">
            <a href="{{ route('beranda') }}" class="hover:text-teal-600">Home</a>
            <span class="mx-2">></span>
            <a href="{{ route('potensi-wisata') }}" class="hover:text-teal-600">Potensi Wisata</a>
            <span class="mx-2">></span>
            <span class="text-gray-800 font-semibold">{{ $wisata['nama'] }}</span>
        </nav>
    </div>
</div>
...
<section class="bg-gradient-to-br from-teal-500 to-green-600 py-16">
    <div class="max-w-screen-xl mx-auto px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
                <h1 class="text-4xl lg:text-5xl font-bold text-white mb-4">{{ $wisata['nama'] }}</h1>
                <p class="text-xl text-white/90 mb-6">{{ $wisata['deskripsi_singkat'] }}</p>
            ...
            <div class="relative">
                <img src="{{ $wisata['gambar_utama'] }}" alt="{{ $wisata['nama'] }}" class="w-full h-96 object-cover rounded-2xl shadow-2xl">
                <div class="absolute top-4 right-4 bg-white/90 backdrop-blur-sm rounded-full px-4 py-2">
                    <span class="text-teal-600 font-bold text-lg">{{ $wisata['harga_tiket'] }}</span>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg mb-8">
                    <h2 class="text-2xl font-bold text-gray-800 mb-4">Tentang {{ $wisata['nama'] }}</h2>
                    <p class="text-gray-600 leading-relaxed">{{ $wisata['deskripsi_lengkap'] }}</p>
                </div>
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        ...
                        <div class="relative group cursor-pointer">
                            <img src="{{ $foto }}" alt="Galeri {{ $wisata['nama'] }}" class="w-full h-48 object-cover rounded-lg transition-transform duration-300 group-hover:scale-105">
            ...
            <div class="lg:col-span-1">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">{{ $wisata['jam_operasional'] }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">{{ $wisata['harga_tiket'] }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">{{ $wisata['kontak'] }}</p>
                            </div>
                        </div>
                    </div>
                    
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <a href="{{ route('kontak') }}" class="w-full bg-gradient-to-r from-teal-500 to-green-600 text-white py-3 px-6 rounded-full font-semibold hover:from-teal-600 hover:to-green-700 transition-all duration-300 inline-flex items-center justify-center">
                            <svg class="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="bg-white rounded-2xl p-6 shadow-lg">
                    ...
                    <div class="space-y-4">
                        ...
                        @foreach(array_slice($other_wisata, 0, 2, true) as $id => $data)
                        <a href="{{ route('detail-wisata', ['id' => $id]) }}" class="block group">
                            <div class="flex gap-3">
                                <img src="{{ $data['gambar_utama'] }}" alt="{{ $data['nama'] }}" class="w-16 h-16 object-cover rounded-lg">
                                <div class="flex-1">
                                    <h4 class="font-semibold text-gray-800 group-hover:text-teal-600 transition-colors">{{ $data['nama'] }}</h4>
                    ...
                    <div class="mt-6 pt-6 border-t border-gray-200">
                        <a href="{{ route('potensi-wisata') }}" class="text-teal-600 font-semibold hover:text-teal-700 transition-colors inline-flex items-center">
