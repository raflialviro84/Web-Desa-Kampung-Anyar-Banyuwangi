...
<section class="max-w-screen-xl mx-auto py-16">
    <div class="bg-green-700 rounded-3xl shadow-xl px-8 py-12">
        ...
        <div class="flex justify-end items-center gap-2 mt-4">
            ...
            <a href="#" class="font-bold text-lg text-white hover:underline">LIHAT FOTO LEBIH BANYAK</a>
        </div>
    </div>
</section>

<!-- Footer -->
<footer class="bg-green-900 text-white pt-12 pb-4 mt-16 relative">
    <div class="max-w-screen-xl mx-auto px-8 grid grid-cols-1 md:grid-cols-4 gap-8">
        <!-- Logo & Address -->
        <div class="flex flex-col gap-4">
            <img src="gambar-icon/logo-desa.png" alt="Logo" class="h-20 w-20 mb-2">
            <h3 class="font-bold text-lg">Pemerintah Desa Kampung Anyar</h3>
            <p class="text-base leading-tight">Jalan Kemuning Nomor 01,<br>
