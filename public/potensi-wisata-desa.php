                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="detail-wisata.php?id=jopuro" class="text-teal-600 font-semibold hover:text-teal-700 transition-colors">Lihat Detail →</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="detail-wisata.php?id=hutan-pinus" class="text-teal-600 font-semibold hover:text-teal-700 transition-colors">Lihat Detail →</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <a href="detail-wisata.php?id=air-terjun" class="text-teal-600 font-semibold hover:text-teal-700 transition-colors">Lihat Detail →</a>
                            </div>
                        </div>
                    </div>
